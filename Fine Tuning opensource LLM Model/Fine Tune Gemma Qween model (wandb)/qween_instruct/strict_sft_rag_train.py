...
class Qwen3InstructFineTuner:
    def __init__(
        ...
        max_seq_length=2048,
        seed=3407,
        early_stopping_patience=3,   # 🔹 ADDED
    ):
        ...
        self.trainer = SFTTrainer(
            ...
            callbacks=[
                        EarlyStoppingCallback(
                            early_stopping_patience=61,  # steps, not epochs
...
trainer = Qwen3InstructFineTuner(
    json_path="/workspace/fine_tune/SFT_dataset/strict_sft.json",
    base_model_path="/workspace/Gen_AI/Qwen3-4B/Base-Qwen3-4B-Instruct-2507",
    save_path="/workspace/fine_tune/qween_instruct/Strict_SFT_RAG/strict_sft_rag_saved_model",
    early_stopping_patience=63,
)
...
trainer.train()
trainer.save()
save_loss_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/qween_instruct/Strict_SFT_RAG/eval_matrix/train_val_loss.png")
# After training
save_accuracy_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/qween_instruct/Strict_SFT_RAG/eval_matrix/train_val_accuracy.png")

save_perplexity_graph_opencv(
    trainer.trainer.state.log_history,
    save_path="/workspace/fine_tune/qween_instruct/Strict_SFT_RAG/eval_matrix/train_val_perplexity.png",
)
