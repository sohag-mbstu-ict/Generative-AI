...
trainer = Qwen3InstructFineTuner(
    ...
    save_path="/workspace/fine_tune/qween_instruct/earlyStopping_saved_model",
...
trainer.train()
trainer.save()
save_loss_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/qween_instruct/eval_matrix/graph_of_eval/train_val_loss.png")
# After training
save_accuracy_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/qween_instruct/eval_matrix/graph_of_eval/train_val_accuracy.png")

save_perplexity_graph_opencv(
    trainer.trainer.state.log_history,
    save_path="/workspace/fine_tune/qween_instruct/eval_matrix/graph_of_eval/train_val_perplexity.png",
)
