...
class Qwen3InstructFineTuner:
    def __init__(
        ...
        max_seq_length=2048,
        seed=3407,
        early_stopping_patience=13,   # 🔹 ADDED
    ):
...
trainer = Qwen3InstructFineTuner(
    ...
    base_model_path="/workspace/Gen_AI/Gemma/gemma3-4b-it",
    save_path="/workspace/fine_tune/gemma/gemma3-4b-it/earlyStopping_saved_model",
...
trainer.train()
trainer.save()
save_loss_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/gemma/gemma3-4b-it/eval_matrix/train_val_loss.png")
# After training
save_accuracy_graph_opencv(trainer.trainer.state.log_history, save_path="/workspace/fine_tune/gemma/gemma3-4b-it/eval_matrix/train_val_accuracy.png")

save_perplexity_graph_opencv(
    trainer.trainer.state.log_history,
    save_path="/workspace/fine_tune/gemma/gemma3-4b-it/eval_matrix/train_val_perplexity.png",
)
