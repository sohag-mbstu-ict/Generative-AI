...
t1 = time.time()
image1 = Image.open("/workspace/Qwen_Image_Edit/input_images/1.jpeg").convert("RGB")
prompt = "Remove the background and replace it with a clean white studio background."
...
output_img_path = "/workspace/Qwen_Image_Edit/output_images/1_image_edit_2511.jpeg"
